...
api-code-gen-ts: #generate/refresh typescript apis
	rm -Rf ./xcherry-ts-api/src/api-gen ; true
	openapi-generator generate -i ./api-schema/xcherry.yaml -g typescript-axios -o ./xcherry-ts-api/src/api-gen -p packageName=xcherry-ts-api -p generateInterfaces=true -p isGoSubmodule=false --git-user-id xcherryio --git-repo-id apis
