...
class AppDatabaseTableConfig(BaseModel):
    """
    AppDatabaseTableConfig
    """ # noqa: E501
    table_name: StrictStr = Field(alias="tableName")
    rows: List[AppDatabaseTableRowSelector]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "rows": [AppDatabaseTableRowSelector.from_dict(_item) for _item in obj.get("rows")] if obj.get("rows") is not None else None
        })
        return _obj
