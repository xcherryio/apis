...
class PublishToLocalQueueRequest(BaseModel):
    """
    ...
    messages: Optional[List[LocalQueueMessage]] = None
    __properties: ClassVar[List[str]] = ["namespace", "processId", "messages"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "messages": [LocalQueueMessage.from_dict(_item) for _item in obj.get("messages")] if obj.get("messages") is not None else None
        })
        return _obj
