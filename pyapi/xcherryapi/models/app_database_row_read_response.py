...
class AppDatabaseRowReadResponse(BaseModel):
    """
    AppDatabaseRowReadResponse
    """ # noqa: E501
    columns: Optional[List[AppDatabaseColumnValue]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "columns": [AppDatabaseColumnValue.from_dict(_item) for _item in obj.get("columns")] if obj.get("columns") is not None else None
        })
        return _obj
