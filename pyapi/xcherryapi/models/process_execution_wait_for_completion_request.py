...
class ProcessExecutionWaitForCompletionRequest(BaseModel):
    """
    the request for waiting for a process completion
    """ # noqa: E501
    namespace: StrictStr
    process_id: StrictStr = Field(alias="processId")
    timeout_seconds: Optional[StrictInt] = Field(default=None, description="the timeout for the waiting operation", alias="timeoutSeconds")
    __properties: ClassVar[List[str]] = ["namespace", "processId", "timeoutSeconds"]
