...
class ProcessExecutionStopRequest(BaseModel):
    """
    the request for stopping a process execution
    """ # noqa: E501
    namespace: StrictStr
    process_id: StrictStr = Field(alias="processId")
    stop_type: Optional[ProcessExecutionStopType] = Field(default=None, alias="stopType")
    __properties: ClassVar[List[str]] = ["namespace", "processId", "stopType"]
