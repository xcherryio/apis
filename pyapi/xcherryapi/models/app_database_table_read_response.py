...
class AppDatabaseTableReadResponse(BaseModel):
    """
    AppDatabaseTableReadResponse
    """ # noqa: E501
    table_name: Optional[StrictStr] = Field(default=None, alias="tableName")
    rows: Optional[List[AppDatabaseRowReadResponse]] = None
    __properties: ClassVar[List[str]] = ["tableName", "rows"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "rows": [AppDatabaseRowReadResponse.from_dict(_item) for _item in obj.get("rows")] if obj.get("rows") is not None else None
        })
        return _obj
