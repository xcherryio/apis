...
class AppDatabaseWrite(BaseModel):
    """
    the write operation for state/RPCs to write to the app database values
    """ # noqa: E501
    tables: Optional[List[AppDatabaseTableWrite]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tables": [AppDatabaseTableWrite.from_dict(_item) for _item in obj.get("tables")] if obj.get("tables") is not None else None
        })
        return _obj
