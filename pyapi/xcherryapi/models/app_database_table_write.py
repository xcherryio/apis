...
class AppDatabaseTableWrite(BaseModel):
    """
    AppDatabaseTableWrite
    """ # noqa: E501
    table_name: StrictStr = Field(alias="tableName")
    rows: Optional[List[AppDatabaseRowWrite]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "rows": [AppDatabaseRowWrite.from_dict(_item) for _item in obj.get("rows")] if obj.get("rows") is not None else None
        })
        return _obj
