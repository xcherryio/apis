...
class LocalQueueCommand(BaseModel):
    """
    LocalQueueCommand
    """ # noqa: E501
    queue_name: StrictStr = Field(alias="queueName")
    count: Optional[StrictInt] = Field(default=1, description="the number of identical messages to await")
    __properties: ClassVar[List[str]] = ["queueName", "count"]
