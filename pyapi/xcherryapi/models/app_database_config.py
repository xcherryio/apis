...
class AppDatabaseConfig(BaseModel):
    ...
    """ # noqa: E501
    tables: Optional[List[AppDatabaseTableConfig]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tables": [AppDatabaseTableConfig.from_dict(_item) for _item in obj.get("tables")] if obj.get("tables") is not None else None
        })
        return _obj
