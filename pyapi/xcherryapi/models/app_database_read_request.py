...
class AppDatabaseReadRequest(BaseModel):
    """
    the request to read the selected rows of configured app database tables
    """ # noqa: E501
    tables: Optional[List[AppDatabaseTableReadRequest]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tables": [AppDatabaseTableReadRequest.from_dict(_item) for _item in obj.get("tables")] if obj.get("tables") is not None else None
        })
        return _obj
