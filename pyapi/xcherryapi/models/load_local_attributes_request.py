...
class LoadLocalAttributesRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "keysToLoadNoLock": obj.get("keysToLoadNoLock"),
            "keysToLoadWithLock": obj.get("keysToLoadWithLock"),
            "lockType": obj.get("lockType")
        })
        return _obj
