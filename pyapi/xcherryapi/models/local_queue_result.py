...
class LocalQueueResult(BaseModel):
    """
    LocalQueueResult
    """ # noqa: E501
    status: CommandStatus
    queue_name: StrictStr = Field(alias="queueName")
    messages: Optional[List[LocalQueueMessageResult]] = None
    __properties: ClassVar[List[str]] = ["status", "queueName", "messages"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "messages": [LocalQueueMessageResult.from_dict(_item) for _item in obj.get("messages")] if obj.get("messages") is not None else None
        })
        return _obj
